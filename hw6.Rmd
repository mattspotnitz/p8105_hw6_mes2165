...
cv_df = 
  ...
  mutate(
   ...
   mutate(
    model_one = map2_dbl(model_one, test, ~rmse(model = .x, data = .y)),
    model_two = map2_dbl(model_two, test, ~rmse(model = .x, data = .y)),
    model_three = map2_dbl(model_three, test, ~rmse(model = .x, data = .y)))
```
